...
::
  ...
  ROUTER_GW_IP=$(openstack port list -c "Fixed IP Addresses" -f json --device-owner 'network:router_gateway' | jq --raw-output '.[0]."Fixed IP Addresses"[0].ip_address'172.24.5.74)
